# - two kinds of data: 
#   1. record type: structure data into meaningful groups(has overhead), ex. tables in a database
#   2. primitive type: your building blocks(built-in types)
# - you can write small objects(classes): ex. class Money(number + currency), or 
#   class Range(upper_bound + lower_bound), or special strings like ZIP codes and phone numbers
# - from primitive data types to object-oriented data types
#   use 1. replace data value with object on individual data values
