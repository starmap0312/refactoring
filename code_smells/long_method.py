# - little methods: better explanation, sharing, and choosing
# - overhead of little methods: readers need to switch context, good naming can make the code
#   easier to understand(do not need to look into the body)
...
# - difficulty: if there are too many parameters and temp variables, it is hard to extract
#   method
